                    ...
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="proses_login.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user" class="form-control input-sm" placeholder="Password" required="" autocomplete="off">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <center><input type="submit" name="login" value="login" class="btn btn-success btn-md" value="Login">
                            </div>
                        </form>
                    </div>
                </div>
